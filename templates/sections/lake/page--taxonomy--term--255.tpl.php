...
<div role="document" class="page">
  ...
  <div class="l-slider">     
    <div class="front-message">
      <h2 class="front-title"><span><?php print t('Lake Yojoa') ?></span></h2>
      <h5 class="portal honduras"><?php print t("water and green life") ?></h5>
      <div class="hash">
        <div class="row">
                ...
                <ul class="inline">
                  ...
                  <li class="list-inline">
                    <div class="icon-inside">
                      <a class="hotels" title="<?php print t("List of Hotels at Honduras") ?>" rel="<?php print t('List of Services at Honduras') ?>" target="_blanck" href="<?php print $link_hotels ?>?field_turistic_section_tid=255"><i class="fa-hoteles"></i> <?php print t("Hotels") ?></a>
                    </div>
                  </li>
                  <li class="list-inline">
                    <div class="icon-inside">
                      <a class="restaurants" title="<?php print t("List of Restaurants at Honduras")?>" rel="<?php print t('List of Services at Honduras') ?>" target="_blanck" href="<?php print $link_restaurants ?>?field_turistic_section_tid=255"><i class="fa-restaurantes"></i> <?php print t("Restaurants") ?> </a>
                    </div>
                  </li>
                  <li class="list-inline">
                    <div class="icon-inside">
